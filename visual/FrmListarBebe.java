...
public class FrmListarBebe extends javax.swing.JDialog {

    private AdmBebe admBebe=AdmBebe.getAdmBebe();
    
    public FrmListarBebe(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        admBebe.llenarTabla(tblBebe, lblTotal);
    }
